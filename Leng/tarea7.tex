...
En la segunda línea, se evalúa una expresión, en la que, la operación más anidada asigna a k la continuación en ese momento de la ejecución de la expresión. Y además, asigna $k$ a $c$. Y por último aplica 4 a $k$, tenemos la continuación de la siguiente forma:\\
$\lambda\uparrow$ (v) (* 1 (* 2 (* 3 (+ v 5))))\\
(($\lambda\uparrow$ (v) (* 1 (* 2 (* 3 (+ v 5))))) 4)\\ Que da como resultado:
\begin{verbatim}
> (* 1 (* 2 (* 3 (+ 4 5))))
> (* 1 (* 2 (* 3 9)))
> (* 1 (* 2 27))
...
Por lo que en la continuación que guarda c, se devuelve cero. La función queda de esta manera:\\
$\lambda\uparrow$ (v) (* 1 (* 2 (* 3 (+ v 5))))\\
